...
def make_pipeline():
    ...
    pipeline = [{'$match':{'user.statuses_count':{'$gt':100},'user.time_zone' :'Brasilia'}},
    {'$project':{'followers':'$user.followers_count','tweets':'$user.statuses_count','screen_name':'$user.screen_name'}}
