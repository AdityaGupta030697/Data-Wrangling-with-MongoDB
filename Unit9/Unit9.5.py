...
def make_pipeline():
    ...
    pipeline = [{'$match':{'country':'India'}},{'$unwind':'$isPartOf'},{'$group':{'_id':'$isPartOf','avg_r':{'$avg':'$population'}}},{'$group':{'_id':'India Regional City Population Average','avg':{'$avg':'$avg_r'}}},{'$sort':{'avg':-1}},{'$limit':1}]
    return pipeline
